    ...
    const plans = [
        {
            ...
            type: "fixed",
            features: [
                { text: "Jusqu'à 50 commandes / mois", icon: "M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" },
                { text: "Gestion de base des commandes", icon: "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" },
                { text: "Analytique de base", icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" },
                { text: "Support par Email", icon: "M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2-2v10a2 2 0 002 2z" }
            ]
        },
        {
            ...
            type: "variable",
            features: [
                { text: "Gestion de commandes IA", icon: "M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2-2v10a2 2 0 002 2z" },
                ...
                { text: "Automatisation de base", icon: "M13 10V3L4 14h7v7l9-11h-7z" }
            ]
        },
        {
            ...
            popular: true,
            features: [
                { text: "Automatisation avancée", icon: "M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a2 2 0 00-1.96 1.414l-.722 2.526a2 2 0 01-3.337 0l-.722-2.526a2 2 0 00-1.96-1.414l-2.387.477a2 2 0 00-1.022.547M19.428 15.428a2 2 0 01-3.337 0l-.722-2.526a2 2 0 00-3.337 0l-.722 2.526a2 2 0 01-3.337 0" },
                { text: "Confirmation de commande intelligente", icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" },
                { text: "Tableau de bord analytique client", icon: "M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" }
            ]
        },
        {
            ...
            type: "variable",
            features: [
                { text: "Automatisation IA complète", icon: "M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" },
                { text: "Accès API", icon: "M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" },
                { text: "Collaboration d'équipe", icon: "M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" },
                { text: "Support prioritaire", icon: "M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z" }
            ],
            doubleButton: true
        }
    ];
            ...
            <div className="container mx-auto px-4 sm:px-6">
                ...
                <div className="max-w-3xl mx-auto text-center mb-20 space-y-6">
                    ...
                    <h2 className="text-4xl lg:text-6xl font-black text-heading dark:text-white leading-[1.1] tracking-tight animate-slide-up">
                        Des plans adaptés à <br />
                        <span className="text-primary italic">votre croissance.</span>
                    </h2>
                    <p className="text-lg lg:text-xl text-body dark:text-slate-400 leading-relaxed font-medium animate-slide-up [animation-delay:0.1s]">
                        Commencez gratuitement et faites évoluer votre infrastructure à mesure que votre business explose.
                    </p>
                </div>
                                    ...
                                    <div className="space-y-3 w-full">
                                        {plan.options.map((opt, idx) => (
                                            <div key={idx} className="flex items-center justify-between gap-4 p-3 rounded-2xl bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800 text-xs sm:text-sm font-bold">
                                                <span className="text-slate-500 dark:text-slate-400">Jusqu'à <span className="text-heading dark:text-white">{opt.limit}</span> commandes</span>
                ...
                <div className="mt-20 text-center animate-fade-in [animation-delay:0.8s]">
                    <p className="text-slate-400 dark:text-slate-500 text-xs font-bold uppercase tracking-[0.2em] mb-4">Essai gratuit de 14 jours • Aucune carte bancaire requise</p>
