    ...
    <section className="py-24 lg:py-32 bg-[#f8fbff] overflow-hidden">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 max-w-7xl mx-auto items-stretch">
          ...
          <div className="lg:col-span-4 bg-white rounded-[40px] p-8 border border-slate-100 shadow-sm flex flex-col items-center text-center justify-center animate-slide-up" style={{ animationDelay: '0.3s' }}>
