        ...
        <footer className="bg-white dark:bg-slate-950 border-t border-slate-100 dark:border-slate-800 pt-24 pb-12 overflow-hidden relative transition-colors duration-500">
            ...
            <div className="container mx-auto px-4 sm:px-6 relative z-10">
                ...
                <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 pb-20 border-b border-slate-100 dark:border-slate-800 mb-20">
                    ...
                    <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-3 gap-12 text-reveal-container">
                        {/* Plateforme Column */}
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex flex-col gap-4">
                                <div className="p-4 bg-slate-50 dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 flex items-center gap-4 transition-all hover:bg-white dark:hover:bg-slate-800 border-transparent hover:border-slate-100 dark:hover:border-slate-700">
                                    <div className="w-8 h-8 flex items-center justify-center bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 shrink-0 shadow-sm text-slate-400 dark:text-slate-500">
                                ...
                                <a href="mailto:contact@rise.dz" className="flex items-center gap-4 p-4 bg-slate-50 dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 hover:border-primary/30 hover:bg-white dark:hover:bg-slate-800 hover:shadow-lg hover:shadow-slate-200/50 dark:hover:shadow-none transition-all group">
                                    <div className="w-8 h-8 flex items-center justify-center bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 shrink-0 shadow-sm text-primary group-hover:bg-primary group-hover:border-primary group-hover:text-white transition-colors">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-sm font-extrabold text-slate-600 dark:text-slate-300 group-hover:text-primary transition-colors">contact@rise.dz</div>
                                    </div>
                                </a>
                                <a href="tel:+213555123456" className="flex items-center gap-4 p-4 bg-slate-50 dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 hover:border-emerald-500/30 hover:bg-white dark:hover:bg-slate-800 hover:shadow-lg hover:shadow-emerald-100/50 dark:hover:shadow-none transition-all group">
                                    <div className="w-8 h-8 flex items-center justify-center bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 shrink-0 shadow-sm text-emerald-500 group-hover:bg-emerald-500 group-hover:border-emerald-500 group-hover:text-white transition-colors">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-8">
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-2">
                        <a href="/mentions-legales" className="text-[11px] font-black text-slate-400 hover:text-primary dark:hover:text-primary-light transition-colors uppercase tracking-[0.1em]">Mentions Légales</a>
                        <a href="/politique-de-confidentialite" className="text-[11px] font-black text-slate-400 hover:text-primary dark:hover:text-primary-light transition-colors uppercase tracking-[0.1em]">Politique de Confidentialité</a>
                        <a href="/cgv" className="text-[11px] font-black text-slate-400 hover:text-primary dark:hover:text-primary-light transition-colors uppercase tracking-[0.1em]">CGV</a>
                    </div>
                </div>
            </div>
        </footer>
