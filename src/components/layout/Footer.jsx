                ...
                <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 pb-20 border-b border-slate-100 dark:border-slate-800 mb-20">
                    <div className="lg:col-span-5 space-y-8">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <a href="https://wa.me/213560800355" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl bg-slate-50 dark:bg-slate-900 flex items-center justify-center text-slate-400 dark:text-slate-500 hover:bg-green-500 dark:hover:bg-green-500 hover:text-white transition-all border border-slate-100 dark:border-slate-800 group shadow-sm transition-all hover:-translate-y-1">
                    ...
                    <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 text-reveal-container">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                <a href="tel:0560800355" className="flex items-center gap-4 p-4 bg-slate-50 dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 hover:border-emerald-500/30 hover:bg-white dark:hover:bg-slate-800 hover:shadow-lg transition-all group overflow-hidden">
                                    ...
                                    <div className="min-w-0">
                                        ...
                                        <div className="text-sm font-bold text-slate-600 dark:text-white group-hover:text-emerald-500 transition-colors">0560800355</div>
                                    </div>
                                </a>
                            </div>
                        </div>
